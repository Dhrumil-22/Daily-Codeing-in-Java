...
if (r.next()) {
	...
	st.executeUpdate("insert into information(first_name,last_name,user_name,password) values('"+request.getParameter("fn")+"','"+request.getParameter("ln")+"','"+request.getParameter("un")+"','"+request.getParameter("pass")+"')");
